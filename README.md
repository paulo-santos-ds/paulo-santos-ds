...
| Relatório de Eficácia de Vendas | [Dashboard Qlik Sense](https://github.com/paulo-santos-ds/Dashboards/tree/main) |  `Qlik Sense`, `Csv` | Este projeto visa analisar os dados de vendas de produtos agrícolas, identificando padrões nas informações disponíveis e compreender as preferências dos clientes e o impacto de fatores externos no consumo. |
