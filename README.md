...
| API de IA Generativa  | [LLM Generativa DeepSeek](https://github.com/paulo-santos-ds/LLM_Generativa_DeepSeek) | `Python`,`Pandas`, `c#`, `Streamlit` |Este projeto é uma aplicação web desenvolvida utilizando a biblioteca Streamlit em Python, que permite a geração de texto através de uma IA generativa, especificamente a DeepSeek-R1|
