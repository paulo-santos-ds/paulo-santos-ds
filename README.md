...
| Teste A-B | [Testing_A_B](https://github.com/paulo-santos-ds/Projects/blob/main/Testing_A_B_.ipynb) | `Python`,`Pandas`, `Scikit Learn`, `Matplotlib`, `Statsmodel` | O propósito do teste A/B é comparar diferentes amostras de conteúdo e design em pares. |
...
| Análise Corridas de Taxi | [Corridas de Taxi](https://github.com/paulo-santos-ds/Analise_corrida_taxi/tree/main) |  `Python`, `Pandas`, `Scikit Learn`, `Numpy`, `Seaborn`, `Matplotlib`, `Math` | ste projeto tem como objetivo analisar os dados de um aplicativo fictício de caronas. Encontrar padrões nas informações disponíveis, entender as preferências dos passageiros e o impacto de fatores externos nas corridas.|
